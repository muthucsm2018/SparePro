...
gj.grid.config = {
    ...
    CustomPagingComments: {
        style: {
            wrapper: 'gj-grid-wrapper',
            table: 'gj-grid gj-grid-bootstrap gj-grid-bootstrap-4 table table-bordered table-hover table-responsive',
            content: {
                rowSelected: 'active'
            }
        },
    ...
    editMode: function ($grid, $cell, column, record) {
        ...
        if ($cell.attr('data-mode') !== 'edit') {
            if (column.editor) {
                ...
                //if ($editorField.prop('tagName').toUpperCase() === "INPUT" && $editorField.prop('type').toUpperCase() === 'TEXT') { //Changed by Logesh 
                if ($editorField.prop('tagName') === "INPUT" && $editorField.prop('type') === 'TEXT') { 
...
gj.grid.plugins.pagination = {
    ...
    private: {
        ...
        localization: function (data) {
            ...
            } else if (data.uiLibrary === 'CustomPagingOne') {
                gj.grid.plugins.pagination.private.localizationCustomPagingOne(data);
            }
            else if (data.uiLibrary === 'CustomPagingTwo') {
                gj.grid.plugins.pagination.private.localizationCustomPagingTwo(data);
            }
            else if (data.uiLibrary === 'CustomPagingThree') {
                gj.grid.plugins.pagination.private.localizationCustomPagingThree(data);
            }
            else if (data.uiLibrary === 'CustomPagingComments') {
                gj.grid.plugins.pagination.private.localizationCustomPagingComments(data);
            }             
            else {
        ...
        localizationBootstrap4: function (data) {
            ...
            if (typeof (data.pager.leftControls) === 'undefined') {
                data.pager.leftControls = [
                    $('<button class="btn form-PagingBoxcontrol btn-sm gj-cursor-pointer">' + (data.icons.first || msg.First) + '</button>').attr('title', msg.FirstPageTooltip).attr('data-role', 'page-first'),
                    $('<button class="btn form-PagingBoxcontrol btn-sm gj-cursor-pointer">' + (data.icons.previous || msg.Previous) + '</button>').attr('title', msg.PreviousPageTooltip).attr('data-role', 'page-previous'),
                    $('<div>' + msg.Page + '</div>'),
                    $('<div class="input-group"><input data-role="page-number" class="form-Pagingcontrol" type="text" value="0"></div>'),
                    $('<div>' + msg.Of + '</div>'),
                    $('<div data-role="page-label-last">0</div>'),
                    $('<button class="btn form-PagingBoxcontrol btn-sm gj-cursor-pointer">' + (data.icons.next || msg.Next) + '</button>').attr('title', msg.NextPageTooltip).attr('data-role', 'page-next'),
                    $('<button class="btn form-PagingBoxcontrol btn-sm gj-cursor-pointer">' + (data.icons.last || msg.Last) + '</button>').attr('title', msg.LastPageTooltip).attr('data-role', 'page-last'),
                    $('<button class="btn form-PagingBoxcontrol btn-sm gj-cursor-pointer">' + (data.icons.refresh || msg.Refresh) + '</button>').attr('title', msg.Refresh).attr('data-role', 'page-refresh'),
                    $('<select data-role="page-size" class="form-PagingSelectcontrol" width="70"></select>')
                ];
            }
            if (typeof (data.pager.rightControls) === 'undefined') {
                data.pager.rightControls = [
        ...
        localizationCustomPagingOne: function (data) {
            ...
            if (typeof (data.pager.rightControls) === 'undefined') {
                data.pager.rightControls = [
                     $('<button class="btn form-PagingBoxcontrol btn-sm gj-cursor-pointer">' + (data.icons.previous || msg.Previous) + '</button>').attr('title', msg.PreviousPageTooltip).attr('data-role', 'page-previous'),
                     $('<div data-role="page-label-number">0</div>'),
                     $('<div>' + msg.Of + '</div>'),
                     $('<div data-role="page-label-last">0</div>'),
                     $('<button class="btn form-PagingBoxcontrol btn-sm gj-cursor-pointer">' + (data.icons.next || msg.Next) + '</button>').attr('title', msg.NextPageTooltip).attr('data-role', 'page-next'),
        ...
        localizationCustomPagingComments: function (data) {

            var msg = gj.grid.messages[data.locale];

            if (typeof (data.pager.rightControls) === 'undefined') {
                data.pager.leftControls = [
                     $('<button class="btn form-PagingCommentBoxcontrol btn-sm gj-cursor-pointer">' + (data.icons.previous || msg.Previous) + '</button>').attr('title', msg.PreviousPageTooltip).attr('data-role', 'page-previous'),
                    // $('<div data-role="page-label-number">0</div>'),
                    // $('<div>' + msg.Of + '</div>'),
                   //  $('<div data-role="page-label-last">0</div>'),
                     $('<button class="btn form-PagingCommentBoxcontrol btn-sm gj-cursor-pointer">' + (data.icons.next || msg.Next) + '</button>').attr('title', msg.NextPageTooltip).attr('data-role', 'page-next'),
            ...
            if (typeof (data.pager.rightControls) === 'undefined') {
                data.pager.rightControls = [ 
                    $('<div style="font-size: 14px; font-weight: bold;"><i style="overflow: auto;line-height: 0px;">Comments :</i> </div><div data-role="record-total" class="btn-badge" style="background-color:#6610f2;border-radius: .25em;padding: 1px 5px;">0</div>')
                ];
            }
        },
        localizationCustomPagingTwo: function (data) {
        ...
        localizationCustomPagingThree: function (data) {
            ...
            if (typeof (data.pager.rightControls) === 'undefined') {
                data.pager.rightControls = [
                    $('<div style="font-size: 14px; font-weight: bold;"><i>Sub Total Marks :</i> </div><label class="label btn-badge" style="background-color:Gray;padding: 4px 8px" ID="lblSubTotalMarks"></label>'),
                    //$('<label style:width:50px>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>'),
                   // $('<div>Total Marks</div><label ID="lblTotalMarks"></label>'),
                ];
            }
        },
        ...
        reloadPagerControl: function ($control, $grid, page, lastPage, firstRecord, lastRecord, totalRecords) {
            ...
            switch ($control.data('role')) {
                ...
                case 'page-number':
                    ...
                    break;
                case 'page-label-number':
                    $control.text(page).off('change').on('change', gj.grid.plugins.pagination.private.createChangePageHandler($grid, page));
                    break;
